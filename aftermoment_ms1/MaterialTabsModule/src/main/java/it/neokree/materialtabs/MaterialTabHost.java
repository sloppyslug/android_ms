	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                ...
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#8fc31f"));
                iconColor = a.getColor(R.styleable.MaterialTabHost_iconColor,Color.WHITE);
                textColor = a.getColor(R.styleable.MaterialTabHost_textColor,Color.parseColor("#dae000"));
			} finally {
				a.recycle();
			}
		}
