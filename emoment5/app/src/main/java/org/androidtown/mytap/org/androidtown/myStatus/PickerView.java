...
public class PickerView extends RelativeLayout {
    ...
    public void getImagePostion(int postion)
    {
        myImagePositon=postion;
    }
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (!setListView && adapter != null) {
            ...
            if(myImagePositon==0)
            {
                ...
                performSelect(adapter.getCount()/2);

            }else{
                listView.setSelection(myImagePositon);
                firstVisibleItem =myImagePositon;
                performSelect(myImagePositon);
            }
