	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                ...
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#b0b0b0"));
                iconColor = a.getColor(R.styleable.MaterialTabHost_iconColor,Color.WHITE);
                textColor = a.getColor(R.styleable.MaterialTabHost_textColor,Color.BLACK);
			} finally {
				a.recycle();
			}
		}
