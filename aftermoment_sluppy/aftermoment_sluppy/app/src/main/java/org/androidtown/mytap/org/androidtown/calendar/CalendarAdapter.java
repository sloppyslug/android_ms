...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position%7==6)
        {
            dayView.setTextColor(Color.parseColor("#85aa1d"));
        }else if(position%7==0)
        {
            dayView.setTextColor(Color.parseColor("#85aa1d"));
        }else{
            dayView.setTextColor(Color.parseColor("#c9c900"));
        }
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    try {
                        ...
                        dayInfo[i][0] = d.getString("emotion");
                        dayInfo[i][1] = d.getString("comment");
                        Log.d(MainActivity.TAG, "(화면 2) emotion : " + dayInfo[i][0]);
                        Log.d(MainActivity.TAG, "(화면 2) emotion : " + dayInfo[0][0]);
