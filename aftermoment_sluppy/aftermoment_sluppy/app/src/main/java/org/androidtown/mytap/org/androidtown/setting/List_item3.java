 ...
 */
public class List_item3 extends RelativeLayout {
    ...
    public List_item3(Context context) {
        super(context);
        mContext = context;
        init(context);
    }

    public List_item3(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(context);
    }
    ...
    public void init(Context context) {
        ...
        inflater.inflate(R.layout.friendname_setting3, this, true);
