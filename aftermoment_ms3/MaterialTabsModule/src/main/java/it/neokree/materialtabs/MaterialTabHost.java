	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                ...
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#85aa1d"));
                iconColor = a.getColor(R.styleable.MaterialTabHost_iconColor,Color.WHITE);
                textColor = a.getColor(R.styleable.MaterialTabHost_textColor,Color.parseColor("#c9c900"));
			} finally {
				a.recycle();
			}
		}
