...
public class MaterialTab implements View.OnTouchListener {
	...
	public void disableTab() {
		...
		this.selector.setBackgroundColor(textColor);
	...
	public void activateTab() {
		// set full color text
		if(text != null)
			this.text.setTextColor(Color.parseColor("#85aa1d"));
		// set 100% alpha to icon
		if(icon != null)
			setIconAlpha(0xFF);
			
		// set accent color to selector view
		this.selector.setBackgroundColor(Color.parseColor("#85aa1d"));
        ...
        if(event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if(!deviceHaveRippleSupport()) {
                ...
                this.background.reveal(lastTouchedPoint.x, lastTouchedPoint.y,
                        Color.WHITE,0, REVEAL_DURATION, new Animator.AnimatorListener() {
                    @Override
